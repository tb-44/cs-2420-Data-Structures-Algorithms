...
public class Outcast {
	...
	public static void main(String[] args) {
		WordNet wordnet = new WordNet("src/wordNet/synsets.txt", "src/wordNet/hypernyms.txt");
	    Outcast outcast = new Outcast(wordnet);
	    String[] outcasts = {"src/wordNet/outcast5.txt", "src/wordNet/outcast8.txt", "src/wordNet/outcast11.txt"};
